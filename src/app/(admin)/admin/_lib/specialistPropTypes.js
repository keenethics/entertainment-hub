...
export const activityTypePropType = PropTypes.shape({
  ...relatedInstanceCore,
...
export const requestPropType = PropTypes.shape({
  ...relatedInstanceCore,
  activityTypes: PropTypes.arrayOf(activityTypePropType),
});

export const activityTypeCutPropType = PropTypes.shape({
  id: PropTypes.string.isRequired,
  activityType: activityTypePropType,
